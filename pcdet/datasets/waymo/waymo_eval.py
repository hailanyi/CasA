...
def main():
    ...
    parser.add_argument('--pred_infos', type=str, default='/home/projects/wh/OpenProjects/OpenPCDet/output/one_frame/waymo_models/voxel_rcnn_0.1/default/eval/epoch_3/val/default/result.pkl', help='pickle file')
    ...
    ap_dict = eval.waymo_evaluation(
        gt_infos_dst, gt_infos_dst, class_name=args.class_names, distance_thresh=1000, fake_gt_infos=True
    )
